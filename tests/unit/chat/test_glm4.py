...
class TestToolParsingChatTokenizer:
    def test_glm4_parsing_with_properly_formatted_tool_calls(
        self, glm4_chat_tokenizer, sample_tools
    ):
        text = """
        get_weather
        <arg_key>location</arg_key>
    ...
    def test_glm4_parsing_capability_for_missing_start_tokens(
        self, glm4_chat_tokenizer, sample_tools
    ):
    ...
    def test_glm4_tokenizer_integration_with_pattern_matching(
        self, glm4_chat_tokenizer, sample_tools
    ):
        parser = glm4_chat_tokenizer.tool_parser
    ...
    def test_tool_parsing_chat_tokenizer_with_glm4_pattern(
        self, mock_tokenizer, glm4_parser, sample_tools
    ):
...
class TestStreaming:
    def test_glm4_streaming_with_missing_start_token(self, glm4_chat_tokenizer, sample_tools):
        ...
        assert json.loads(final_result.tool_calls[0].function.arguments) == {
